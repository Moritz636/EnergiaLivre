...
DROP POLICY IF EXISTS "Users can view own uploads" ON faturas_upload;
CREATE POLICY "Users can view own uploads"
ON faturas_upload FOR SELECT TO authenticated
USING (user_id = auth.uid());

DROP POLICY IF EXISTS "Users can insert own uploads" ON faturas_upload;
CREATE POLICY "Users can insert own uploads"
ON faturas_upload FOR INSERT TO authenticated
WITH CHECK (user_id = auth.uid());

DROP POLICY IF EXISTS "Admin can view all uploads" ON faturas_upload;
...
DROP POLICY IF EXISTS "Admin can update all uploads" ON faturas_upload;
