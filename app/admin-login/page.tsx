          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-900 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white focus:border-purple-500 focus:ring-1 focus:ring-purple-500 outline-none transition"
                required
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-900 border border-white/10 rounded-xl py-3 pl-10 pr-12 text-white focus:border-purple-500 focus:ring-1 focus:ring-purple-500 outline-none transition"
                required
              />
              <button
                type="button"
