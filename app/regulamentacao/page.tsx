...
export default function RegulamentacaoPage() {
  return (
    <div className="min-h-screen bg-[#020617] text-slate-200 font-sans flex flex-col overflow-x-hidden">
      ...
      {/* --- SOCIAL PROOF: NÚMEROS CONCRETOS --- */}
      <section className="max-w-5xl mx-auto px-6 mb-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="p-6 rounded-2xl bg-emerald-500/5 border border-emerald-500/20 text-center">
            <p className="text-3xl font-black text-emerald-400">R$ 0,95</p>
            <p className="text-xs text-slate-400 mt-1">Valor de 1 Moeda Energia</p>
          </div>
          <div className="p-6 rounded-2xl bg-emerald-500/5 border border-emerald-500/20 text-center">
            <p className="text-3xl font-black text-emerald-400">até 32%</p>
            <p className="text-xs text-slate-400 mt-1">de economia na fatura</p>
          </div>
          <div className="p-6 rounded-2xl bg-emerald-500/5 border border-emerald-500/20 text-center">
            <p className="text-3xl font-black text-emerald-400">24h</p>
            <p className="text-xs text-slate-400 mt-1">análise de viabilidade</p>
          </div>
          <div className="p-6 rounded-2xl bg-emerald-500/5 border border-emerald-500/20 text-center">
            <p className="text-3xl font-black text-emerald-400">100%</p>
            <p className="text-xs text-slate-400 mt-1">conformidade ANEEL</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 mb-16">
        <div className="p-8 rounded-3xl bg-gradient-to-br from-emerald-500/5 to-blue-500/5 border border-emerald-500/20">
          <div className="flex items-center gap-2 mb-4">
            <div className="w-3 h-3 rounded-full bg-emerald-500 animate-pulse" />
            <span className="text-[10px] text-emerald-400 font-black uppercase tracking-wider">Caso real</span>
          </div>
          <blockquote className="text-lg md:text-xl text-slate-200 font-medium leading-relaxed mb-4">
            &ldquo;Consegui reduzir minha conta de energia em R$ 112 por mês sem instalar painel nenhum.
            A plataforma é simples e o suporte respondeu em menos de 2 horas.&rdquo;
          </blockquote>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-500/30 to-emerald-400/10 flex items-center justify-center text-emerald-400 font-black">
              M
            </div>
            <div>
              <p className="text-sm font-bold text-white">Maria S.</p>
              <p className="text-[10px] text-slate-500">Consumidora · Natal/RN · Cliente desde Jan/2026</p>
            </div>
