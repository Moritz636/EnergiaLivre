...
function EmailConfirmadoContent() {
  ...
  // After 10s of reading, show the popup
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white overflow-hidden relative">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 md:py-20 relative z-10">
        ...
        {/* The Vision — 48 Leis aplicada: Lei 28 (Enter Action with Boldness) */}
        ...
        {/* Trust — Lei 15: Crush Your Enemy Totally (eliminate doubt) */}
        <div className="rounded-2xl bg-white/[0.03] border border-white/10 p-8 md:p-10 mb-8">
        ...
        {/* Benefits — Lei 32: Play to People's Fantasies + Lei 40: Despise the Free Lunch */}
        <div className="rounded-2xl bg-white/[0.03] border border-white/10 p-8 md:p-10 mb-8">
        ...
        {/* Scarcity + Redirect countdown — Lei 3: Conceal Your Intentions + Lei 36: Disdain Things You Cannot Have */}
      ...
      {/* Popup overlay — Arts of Seduction: The Coquette (give attention, pull away) */}
      {showPopup && (
